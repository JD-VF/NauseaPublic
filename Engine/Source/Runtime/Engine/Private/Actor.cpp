...
//#NAUSEA_BEGIN_TAKE_DAMAGE_EVENT
	OnTakeDamage.Broadcast(this, ActualDamage, DamageEvent, EventInstigator, DamageCauser); //See AActor::OnTakeDamage for more information.
