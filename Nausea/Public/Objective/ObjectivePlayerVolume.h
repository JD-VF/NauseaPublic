...
public:
	...
	static UObjectivePlayerVolume* CreatePlayerVolumeObjective(const UObject* WorldContextObject, TSubclassOf<UObjectivePlayerVolume> ObjectiveClass, const FString& InObjectiveID, TArray<AActor*> InOverlapActors);

	template<class T>
	static T* CreatePlayerVolumeObjective(const UObject* WorldContextObject, TSubclassOf<UObjectivePlayerVolume> ObjectiveClass, const FString& InObjectiveID, TArray<AActor*> InOverlapActors)
	{
