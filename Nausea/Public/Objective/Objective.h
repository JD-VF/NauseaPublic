...
public:
	...
	static UObjective* CreateObjective(const UObject* WorldContextObject, TSubclassOf<UObjective> ObjectiveClass, const FString& InObjectiveID);

	template<class T>
	static T* CreateObjective(const UObject* WorldContextObject, TSubclassOf<UObjective> ObjectiveClass, const FString& InObjectiveID)
	{
...
public:
	...
	TAssetSubclassOf<class UMissionObjectiveUserWidget> GetObjectiveWidget() const { return ObjectiveWidget; }
...
protected:
	...
	TAssetSubclassOf<class UMissionObjectiveUserWidget> ObjectiveWidget;
