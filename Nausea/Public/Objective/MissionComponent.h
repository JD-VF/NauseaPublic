...
public:
	...
	static UMissionComponent* CreateMission(const UObject* WorldContextObject, TSubclassOf<UMissionComponent> MissionComponentClass, const FText& MissionTitle);
...
public:
	...
	UFUNCTION(BlueprintPure, Category = MissionComponent)
	TAssetSubclassOf<class UMissionContainerUserWidget> GetMissionContainerWidget() const { return MissionContainerWidget; }
...
protected:
	...
	TAssetSubclassOf<class UMissionContainerUserWidget> MissionContainerWidget;
